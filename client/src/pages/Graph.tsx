...
const Graph: React.FC = () => {
	...
	*/
	...
	class Transition {
		...
		get midpoint() {
			return [
				(this.srcVector.x + this.destVector.x) / 2,
				(this.srcVector.y + this.destVector.y) / 2,
			];
		}
		...
		draw() {
			...
			if (this.srcVector && this.destVector) {
				...
				*/
				let [x, y] = [
					this.destVector.x - this.srcVector.x,
					this.destVector.y - this.srcVector.y,
				];
